...
%---------------------------------------------------------
 \cventry
    {Brock Solutions (Transportation and Logistics Unit)} % Organization
    {Software Developer I} % Job title
...
%---------------------------------------------------------
 \cventry
    {SAP HANA and Analytics} % Organization
    {Agile Developer Intern (Infrastructure Team)} % Job title
    {Vancouver, BC, Canada} % Location
...
%---------------------------------------------------------
 \cventry
    {FORM} % Organization
    {Web Software Developer Intern} % Job title
    {Vancouver, BC, Canada} % Location
...
%---------------------------------------------------------    
\cventry
    {LedgerDocs}  % Organization
    {Web Applications Developer} % Job title
